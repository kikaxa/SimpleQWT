...
public:
    ...
    inline bool intersect( const QVector3D vertex[3],
...
private:
    ...
    inline QPointF intersection(
        const QVector3D& p1, const QVector3D &p2 ) const;

    double d_z;
};

inline bool QwtRasterData::ContourPlane::intersect(
    const QVector3D vertex[3], QPointF line[2],
